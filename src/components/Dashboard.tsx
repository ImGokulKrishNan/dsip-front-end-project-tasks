...
const Dashboard: React.FC<DashboardProps> = ({ stocks, onAddStock, onSelectStock }) => {
   ...
   if (useApiData && portfolioSummary) {
      // Use data from API
      totalInvestedValue = portfolioSummary.totalCapitalInvested;
      currentMarketValue = portfolioSummary.totalCurrentValue;
                        ...
                        <Card className="p-6 border-destructive/50 bg-destructive/5">
                           <div className="flex items-center gap-3 text-destructive">
                              ...
                              <div>
                                 ...
                                 <p className="text-sm text-muted-foreground">{trackersError}</p>
                              </div>
                           </div>
                        </Card>
                     )}
