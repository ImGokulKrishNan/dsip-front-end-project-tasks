            ...
            <Card className="border-primary/10 shadow-sm bg-background">
              ...
              <CardContent className="space-y-5 pb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                  ...
                  {/* Total P&L */}
                  <div className={`space-y-1 p-4 md:p-3 rounded-lg border shadow-sm ${(useApiData && selectedTracker?.tracker?.live_investment_cycle?.net_profit_percentage !== undefined
                    ...
                    <div className={`text-2xl md:text-xl font-black tracking-tight ${(useApiData && selectedTracker?.tracker?.live_investment_cycle?.net_profit_percentage !== undefined
                      ? selectedTracker.tracker.live_investment_cycle.net_profit_percentage
                      : currentReturnPercent
                                ...
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <button
                                      ...
                                      disabled={isUpcoming}
                                      className={`flex-1 h-8 rounded-full transition-all duration-300 relative group overflow-hidden ${isCompleted
