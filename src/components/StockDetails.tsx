    ...
    <TooltipProvider>
      <Tooltip open={open} onOpenChange={setOpen}>
        ...
        <TooltipContent
          ...
          sideOffset={5}
        >
          <p className="text-xs leading-relaxed font-normal normal-case">
            {text}
          </p>
        </TooltipContent>
      </Tooltip>
    ...
    <div className="h-full bg-background overflow-auto">
      <div className="px-4 py-5 md:p-6 space-y-6 pb-12 xl:pb-32">
            ...
            <Card className="border-l-4 border-l-emerald-500 shadow-xl animate-in fade-in zoom-in-95 duration-300">
              ...
              <CardContent className="pt-6 space-y-5 p-5">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-bold">
                        {trackerData
                          ? Math.ceil(
                              ((100 -
                                recommendation.partition_status
                                  .time_progress_pct) *
                ...
                <div className="flex flex-col md:flex-row gap-3">
                  ...
                  >
                    <Icons.Check className="mr-2 w-4 h-4" /> Place Order &
                    Confirm
                  </Button>
                  <Button
                    variant="outline"
              ...
              <CardContent className="pt-6 space-y-5 p-5">
                ...
                <div className="flex flex-col md:flex-row gap-3 pt-2">
                  <Button
                    ...
                    disabled={
                      isConfirming || !executedAmount || !executionPrice
                    }
                  >
                    {isConfirming ? (
                      <>
                      ...
                      <>
                        <Icons.Check className="mr-2 w-4 h-4" /> Confirm &
                        Record
                      </>
                    )}
                  </Button>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      setEditConfig({
                        ...
                        loadFactor: (loadFactorMap[displayLoadFactor] ||
                          displayLoadFactor) as any,
                ...
                {!isEditing ? (
                  ...
                  <>
                    ...
                    <div className="flex justify-between md:block border-b md:border-0 pb-2 md:pb-0 border-dashed border-muted">
                      ...
                      <p className="font-semibold">
                        ${displayTotalBudget.toLocaleString()}
                      </p>
                    </div>
                    <div className="flex justify-between md:block border-b md:border-0 pb-2 md:pb-0 border-dashed border-muted">
                      <p className="text-xs text-muted-foreground">
                    ...
                    <div className="flex justify-between md:block border-b md:border-0 pb-2 md:pb-0 border-dashed border-muted">
                      ...
                      <p className="font-semibold">
                        {displayPartitionMonths} Months
                      </p>
                    </div>
                    {displayInitialInvestedAmount !== null &&
                      displayInitialInvestedAmount !== undefined &&
                      Number(displayInitialInvestedAmount) !== 0 && (
                        <div className="flex justify-between md:block border-b md:border-0 pb-2 md:pb-0 border-dashed border-muted">
                          <p className="text-xs text-muted-foreground">
                    ...
                    {displayInitialSharesHeld !== null &&
                      displayInitialSharesHeld !== undefined &&
                      Number(displayInitialSharesHeld) !== 0 && (
                        <div className="flex justify-between md:block pt-1 md:pt-0">
                          <p className="text-xs text-muted-foreground">
                            Initial Shares Held
                          </p>
                          <p className="font-semibold">
                            {Number(displayInitialSharesHeld).toLocaleString(
                              undefined,
                  ...
                  <>
                    ...
                    <div className="space-y-2 md:col-span-2">
                      ...
                      {editConfig.loadFactor !==
                        ...
                        )[displayLoadFactor] || displayLoadFactor) && (
                        <div className="flex items-start gap-1.5 text-amber-500 bg-amber-500/10 border border-amber-500/20 rounded-md px-2.5 py-2">
                          ...
                          <p className="text-[11px] leading-tight">
                            These changes will affect only in the next
                            investment cycle.
                          </p>
                        </div>
                      )}
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      onClick={async () => {
                        ...
                        if (
                          editConfig.convictionLevel < 0 ||
                          editConfig.convictionLevel > 100
                        ) {
                          errors["Overall Conviction"] =
                        ...
                        const hasChanges =
                          ...
                          editConfig.convictionYears !==
                            currentConvictionYears ||
                          editConfig.partitionMonths !==
                            currentPartitionMonths ||
                          ...
                          if (useApiData && trackerData?.trackerId) {
                            ...
                            try {
                              ...
                              const { fetchTrackerDetails } =
                                await import("../store/slices/trackersSlice");
                              dispatch(
                                fetchTrackerDetails(trackerData.trackerId),
                              );

                              console.log(
                                "[StockDetails] Tracker updated successfully",
                              );
                            } catch (error) {
                              console.error(
                                "[StockDetails] Failed to update tracker:",
                                error,
                              );
                              alert(
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription className="pt-2">
                  ...
                  Reducing budget, conviction, or changing structural parameters
                  can disrupt the mathematical execution.
                </DialogDescription>
              </DialogHeader>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription className="pt-2">
                  ...
                  Multiple executions within the same day may accelerate capital
                  deployment.
                </DialogDescription>
              </DialogHeader>
              <DialogFooter className="gap-2 sm:gap-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                ...
                <div className="space-y-1 p-4 md:p-3 rounded-lg bg-gradient-to-br from-blue-500/5 to-blue-600/10 border border-blue-500/10 shadow-sm">
                  ...
                  <div className="text-2xl md:text-xl font-black tracking-tight text-foreground">
                    $
                    {(useApiData &&
                    selectedTracker?.tracker?.live_investment_cycle
                ...
                <div
                  className={`space-y-1 p-4 md:p-3 rounded-lg border shadow-sm ${
                    (useApiData &&
                    selectedTracker?.tracker?.live_investment_cycle
                      ?.net_profit_percentage !== undefined
                      ? selectedTracker.tracker.live_investment_cycle
                ...
                <div className="space-y-1 p-4 md:p-3 rounded-lg bg-gradient-to-br from-purple-500/5 to-purple-600/10 border border-purple-500/10 shadow-sm">
                  ...
                  <div className="text-2xl md:text-xl font-black tracking-tight text-foreground">
                    ...
                    selectedTracker?.tracker?.live_investment_cycle
                      ?.partition_progress
                      ? selectedTracker.tracker.live_investment_cycle.partition_progress.toFixed(
                          1,
                        )
                      : (
                          ((daysInvested % cycleLength) / cycleLength) *
                          100
                        ).toFixed(1)}
                    %
                  </div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs font-mono font-medium text-muted-foreground">
                    {(
                      (displayDeployedAmount / displayTotalBudget) *
                      100
                    ).toFixed(1)}
                    % Complete
                  </span>
                ...
                <div className="relative w-full bg-slate-900/30 rounded-full p-2 ring-1 ring-slate-800/50 shadow-inner">
                  <div className="flex gap-2 w-full">
                    {(() => {
                      ...
                      if (
                        currentCycle + upcomingIndividualCount >=
                        totalCycles
                      ) {
                            ...
                            <Tooltip>
                              ...
                              >
                                <div className="text-center">
                                  ...
                                  <div className="text-[10px] text-slate-400 mt-0.5">
                                    Completed · Click to view partition{" "}
                                    {groupedEnd}
                                  </div>
                                </div>
                              </TooltipContent>
                      ...
                      for (
                        let i = startIndex;
                        i <= Math.min(endIndex, totalCycles);
                        i++
                      ) {
                        const partitionIndex = i;
                        const isCompleted = partitionIndex < currentCycle;
        ...
        <div>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div
                              className={`p-4 rounded-2xl border ${
                                (partitionDetails?.net_profit_percentage ||
                                  0) >= 0
                        ...
                        <div className="py-12 text-center space-y-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-sm text-slate-400 max-w-[250px] mx-auto">
                              This investment cycle is scheduled for a future
                              date.
                            </p>
                          </div>
                        </div>
          ...
          <Dialog
            open={showKillSwitchPopup}
            onOpenChange={setShowKillSwitchPopup}
          >
