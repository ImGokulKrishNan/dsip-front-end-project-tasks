            ...
            {activeView === 'STOCK_DETAILS' && (
              <>
                <div className="space-y-1">
                  <h3 className="text-lg font-bold tracking-tight">Current Holdings</h3>
                ...
                <div className="grid gap-4">
                  ...
                  <div className="p-4 rounded-xl bg-card border shadow-sm space-y-3">
                    <div className="flex items-center gap-1"><span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Current Value</span>
                      <InfoTooltip text="Your investment strategy parameters. These define how your capital is deployed over time." />
                    </div><div className="text-2xl font-bold">₹{Math.round(currentValue).toLocaleString()}</div>
                  </div>
